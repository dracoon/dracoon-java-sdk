...
public enum DracoonApiCode {
    ...
    SERVER_FILE_SEGMENT_NOT_FOUND(-209, "Requested file segment was not found."),
    SERVER_FILE_SEGMENT_INVALID(-210, "Provided file segment is invalid."),
    SERVER_FILE_KEY_NOT_FOUND(-211, "File key could not be found."),
