...
public enum DracoonApiCode {
    ...
    AUTH_UNKNOWN_ERROR(-100, "An authentication/authorization error occurred."),
    AUTH_CLIENT_UNKNOWN(-101, "OAuth client is unknown."),
    AUTH_CLIENT_UNAUTHORIZED(-102, "OAuth client is unauthorized."),
    AUTH_GRANT_TYPE_NOT_ALLOWED(-103, "OAuth grant type is not allowed."),
    AUTH_AUTHORIZATION_REQUEST_INVALID(-104, "OAuth authorization request is invalid."),
    AUTH_AUTHORIZATION_SCOPE_INVALID(-105, "OAuth scope is invalid."),
    AUTH_AUTHORIZATION_ACCESS_DENIED(-106, "OAuth access was denied."),
    AUTH_TOKEN_REQUEST_INVALID(-107, "OAuth token request is invalid."),
    AUTH_TOKEN_CODE_OR_REDIRECT_URI_INVALID(-108, "OAuth authorization code is invalid."),
    AUTH_REFRESH_REQUEST_INVALID(-109, "OAuth token refresh request is invalid."),
    AUTH_REFRESH_TOKEN_INVALID(-110, "OAuth refresh token is invalid."),
    AUTH_UNAUTHORIZED(-111, "Unauthorized."),
    AUTH_USER_TEMPORARY_LOCKED(-112, "User is temporary locked."),
    AUTH_USER_LOCKED(-113, "User is locked."),
    AUTH_USER_EXPIRED(-114, "User is expired."),
