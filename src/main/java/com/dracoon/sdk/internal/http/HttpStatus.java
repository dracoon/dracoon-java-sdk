...
public enum HttpStatus {
    ...
    HttpStatus(int number, String text) {
        mNumber = number;
        mText = text;
    }
    ...
    public boolean is1xxInformational() {
        return mNumber >= 100 && mNumber < 200;
    }

    public boolean is2xxSuccessful() {
        return mNumber >= 200 && mNumber < 300;
    }

    public boolean is3xxRedirection() {
        return mNumber >= 300 && mNumber < 400;
    }

    public boolean is4xxClientError() {
        return mNumber >= 400 && mNumber < 500;
    }

    public boolean is5xxServerError() {
        return mNumber >= 500 && mNumber < 600;
    }
